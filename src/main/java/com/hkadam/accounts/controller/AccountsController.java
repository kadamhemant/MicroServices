package com.hkadam.accounts.controller;
import com.hkadam.accounts.constants.AccountConstants;
import com.hkadam.accounts.dto.CustomerDto;
import com.hkadam.accounts.dto.ErrorResponseDto;
import com.hkadam.accounts.dto.ResponseDto;
...
@Tag(
        name = "CRUD REST APIs for Accounts in AIBank",
        description = "CRUD REST APIs in AIBank to CREATE, UPDATE, FETCH AND DELETE account details"
)
...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "REST API to create new Customer & Account inside AIBank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
